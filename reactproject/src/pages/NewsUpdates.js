...
const newsUpdates = [
    {
        ...
        image: "185b375d0ffd2ccd3ad111685a3c068d_Fotor.jpg",
    ...
    },
    {
        ...
        image: "75439668007-usatsi-24356392_Fotor.jpg",
...
function NewsUpdates() {
    ...
    const [formError, setFormError] = useState(null); // State to handle errors
          ...
          <div className="news-grid">
            {newsUpdates.map((news, index) => (
              <div className="news-item" key={index}>
                <h3>{news.title}</h3>
                <p>{news.summary}</p>
                <img src={`${process.env.PUBLIC_URL}/images/${news.image}`} alt={news.title} />
